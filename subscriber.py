    ...
    def on_message(self, message):
        ...
        if data["location"] == self.location:
            ...
            if self.temp_label:
                ...
                self.temp_line[0].set_xdata(range(len(self.temp_data)))
                self.temp_line[0].set_ydata(self.temp_data)
            ...
            if self.humidity_label:
                ...
                self.humidity_fig.canvas.draw_idle()
